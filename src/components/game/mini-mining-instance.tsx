...
import { BASE_ANIMATION_SPEED_MS, useFrameAnimation } from "@/hooks/use-frame-animation";
import { drawCharacterLayers } from "@/lib/render-character/canvas-utils";
import { renderNatureTile } from "@/lib/render-character/nature-images";
import { getCharacterLayerPath, getToolPath } from "@/lib/render-character/character-paths";
